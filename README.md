...
![alt text](https://github.com/Tenagrim/Discr_graph/blob/master/img/1.png?raw=true)

### Выделение компонент связности в графе:

![alt text](https://github.com/Tenagrim/Discr_graph/blob/master/img/2.png?raw=true)

### Сохренение графа или загрузка сохраненного:

![alt text](https://github.com/Tenagrim/Discr_graph/blob/master/img/3.png?raw=true)

### Приведение графа к ярусно-параллельной форме:

![alt text](https://github.com/Tenagrim/Discr_graph/blob/master/img/4.png?raw=true)
